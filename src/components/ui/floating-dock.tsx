...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-16 items-center gap-4 rounded-2xl bg-card px-4 md:flex",
        className
      )}
    >
      {items.map((item) => (
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-full bg-secondary text-secondary-foreground"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
